...
{
    public class GetMonthlyProfitChartQueryHandler
        : IQueryHandler<
            GetMonthlyProfitChartQuery,
            ApiResponse<List<MonthlyChartDto>>>
    {
        private readonly IDbConnectionFactory _connectionFactory;
        private readonly ICurrentTenantService _currentTenant;

        public GetMonthlyProfitChartQueryHandler(
        ...
        public async Task<ApiResponse<List<MonthlyChartDto>>> Handle(
            GetMonthlyProfitChartQuery request,
